...
if net_import_need is not None and net_import_need >= 500:
    level = "🔴 Kõrge" if net_import_need >= 800 else "🟠 Tähelepanu"
    add_alert(level, "EE bilansivajadus", f"Tarbimine ületab kodumaist tootmist {net_import_need:.0f} MW võrra (reegel: ≥ 500 MW).")
...
st.caption("Tähelepanureeglid on läbipaistvad heuristikad olukorrapildi kiirendamiseks, mitte ametlikud häirepiirid ega prognoosid. Lävendid: |EE–FI spread| 50/100 €/MWh; UMM 300/600 MW; EE bilansivajadus 500/800 MW; voog/DA NTC 90/100%; balancing energy |500/1000| €/MWh; gaasihoidlad <30% või ~7 päeva langus ≥5 pp.")
